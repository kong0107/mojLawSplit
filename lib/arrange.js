...
const charConvertList = [
    ...
    {from: 0xe4ff, to: 0x7fa3, pcode: "C0000009"}, // 「羣」，25年6月
    ...
    {from: 0xe554, to: 0x9176}, // 「酶」不知為何在 25年6月又變成 PUA 的碼了
    ...
    {from: 0xe69b, to: 0x945b, pcode: "I0030006"}, // 「鑛」，25年6月
    {from: 0xe675, to: 0x7ac8},
    {from: 0xe694, to: 0x9c3a},
    {from: 0xe6bb, to: 0x6004},
    {from: 0xe6bf, to: 0x8d0b, pcode: "L0020200"}, // 「贋」，25年6月
    ...
    {from: 0xf061, to: 0x8d0c}, // 「贌」耕權
    {from: 0xf1e6, to: 0x945b, pcode: "J0010001"},
    {from: 0xf24f, to: 0x7a09, pcode: "M0030040"}, // 「稉」，25年6月
    {from: 0xf26d, to: null, pcode: "G0400109"},
    {from: 0xf26d, to: null, pcode: "G0400104"},
    {from: 0xf4e8, to: 0xf7, pcode: "L0060038"},
    {from: 0xf4e9, to: 0xd7},
            ...
            case "C": {
                ...
                if(item.ArticleContent) {
                    ...
                    switch(pcode) {
                        ...
                        default: {
                            const match = text.match(/^\s*第(?: 第)?\s*([零一二三四五六七八九十百]+)\s*([編章節款目])(之([一二三四五六七八九十]+))?\s*(.+)\s*$/); // N0090029 第9章至第11章有問題，25年6月
                            console.assert(match, pcode, text);
                            type = match[2];
