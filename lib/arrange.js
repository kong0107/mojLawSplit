...
const charConvertList = [
    ...
    {from: 0xffe1, to: 0x2266, pcode: "O0020006"}, // 英文版裡應為數學符號，卻成為英鎊符號；另注意英鎊符號有被 G0360001 用到。

    // 符號統一，以避免用一般標點判讀時出錯。
    {from: 0x02cd, to: 0xff3f}, // I0050029
    {from: 0x02d9, to: 0xff0e},
    {from: 0x2027, to: 0xff0e},
    ...
    {from: 0xe53f, to: 0x78b1, pcode: "J0030027"},
